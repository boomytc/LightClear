...
INPUT_AUDIO = "assets/clearvoice_samples/test.wav"
INPUT_DIR = "assets/clearvoice_samples/path_to_input_wavs"
INPUT_SCP = "assets/clearvoice_samples/scp/audio_samples.scp"
OUTPUT_FILE = "outputs/MossFormerGAN_SE_16K/test.wav"
OUTPUT_DIR = "outputs/MossFormerGAN_SE_16K/path_to_output_wavs"
OUTPUT_SCP_DIR = "outputs/MossFormerGAN_SE_16K/path_to_output_wavs_scp"
