...
| [`light_demucs/`](./light_demucs/) | Demucs | 人声隔离、四轨分轨；`Separator` API | `vocal_isolate_web` 自持一份 Demucs | ClearVoice 说话人分离、`speech_separation_web` |
...
| `products/vocal_isolate_web` | `light_demucs` | 人声隔离 / 分轨；不得 import explore |
