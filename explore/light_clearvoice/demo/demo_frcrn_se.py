...
OUTPUT_FILE = str(MODULE_ROOT / "outputs" / "FRCRN_SE_16K" / "input.wav")
OUTPUT_DIR = str(MODULE_ROOT / "outputs" / "FRCRN_SE_16K" / "path_to_output_wavs")
OUTPUT_SCP_DIR = str(MODULE_ROOT / "outputs" / "FRCRN_SE_16K" / "path_to_output_wavs_scp")
